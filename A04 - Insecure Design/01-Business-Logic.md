...
>ثغرة Business Logic هي عيوب في تصميم وتدفق عمل التطبيق تسمح للمهاجم باستغلال القواعد المنطقية للقيام بأفعال غير متوقعة. تحدث هذه الثغرة عندما يضع المطور قيوداً وفحوصات صارمة في الواجهة الأمامية (Front-end) وينسى حمايتها أو التحقق منها في الخلفية (Back-end)، أو عندما يفترض المطور أن المستخدم سيتبع خطوات العمل بترتيب معين (مثل: الخطوة 1 ثم 2 ثم 3)، فيقوم المهاجم بالالتفاف على النظام والقفز مباشرة إلى الخطوة 3 لتخطي الدفع أو التحقق.
