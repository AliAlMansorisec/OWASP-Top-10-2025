...
ثغرة تجبر متصفح الضحية على تنفيذ إجراء غير مرغوب فيه في تطبيق ويب يكون المستخدم مسجلاً للدخول فيه حالياً. المهاجم لا يسرق البيانات مباشرة، بل "ينتحل شخصية" المستخدم لتنفيذ عمليات مثل (تغيير كلمة المرور، تحويل أموال، أو تغيير البريد الإلكتروني).
