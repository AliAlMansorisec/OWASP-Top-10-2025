...
> **هو ثغرة تجبر متصفح الضحية على تنفيذ إجراء غير مرغوب فيه في تطبيق ويب يكون المستخدم مسجلاً للدخول فيه حالياً، مثل تغيير كلمة المرور أو تحويل أموال، دون علمه أو موافقته.**
