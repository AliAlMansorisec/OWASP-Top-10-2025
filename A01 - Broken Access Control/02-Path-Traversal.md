...
> ثغرة تحدث عندما يطلب منك الموقع تحديد اسم ملف لعرضه (مثل صورة أو ملف نصي)، ولكن بدلاً من إعطائه اسم الملف، تقوم بإعطائه أوامر للرجوع إلى الخلف في مجلدات السيرفر (باستخدام `../`). هذا الرمز يخبر السيرفر: "اخرج من مجلد الموقع الحالي، وخذني إلى مجلدات النظام الداخلية الحساسة" مثل ملف كلمات المرور أو إعدادات السيرفر.
