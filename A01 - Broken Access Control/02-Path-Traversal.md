...
> **هو ثغرة تمكن المهاجم من قراءة ملفات تعسفية على السيرفر خارج المجلد المسموح، مثل ملفات النظام الحساسة (`/etc/passwd`) أو كود المصدر أو بيانات الاعتماد، بسبب عدم التحقق الكافي من المسار المدخل من المستخدم.**
