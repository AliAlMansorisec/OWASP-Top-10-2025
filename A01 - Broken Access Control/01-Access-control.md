...
>**ثغرة Broken Access Control تحدث عندما يفشل الموقع في التحقق من صلاحيات المستخدم بعد تسجيل دخوله. هذا يعني أن السيرفر يكتفي بمعرفة أنك "مستخدم مسجل" فيعطيك لوحة تحكم، ولكنه ينسى أن يسأل: "هل يحق لهذا المستخدم بالذات رؤية هذه الصفحة؟"، مما يسمح للمستخدم العادي بالدخول لصفحات المديرين، أو قراءة وتعديل بيانات مستخدمين آخرين بمجرد تغيير أرقام الـ ID في الرابط.**
