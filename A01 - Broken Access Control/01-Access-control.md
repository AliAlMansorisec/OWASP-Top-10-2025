...
- **Vertical Privilege Escalation | تصعيد الصلاحيات الرأسي:** مستخدم عادي يصل لصلاحيات "أدمن".
- **Horizontal Privilege Escalation (IDOR) | تصعيد الصلاحيات الأفقي:** مستخدم يصل لبيانات مستخدم آخر له نفس المستوى من الصلاحيات.
- **Context-dependent | السياق المعتمد:** استغلال منطق العمل للوصول لموارد في حالة غير مسموح بها.
